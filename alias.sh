...
>>>>>>> 54b4702ac50dcca42735ae313bfac848624edfc4
...
echo "alias ddd2='docker ps && docker ps -a && docker images'" | sudo tee -a ~/.$mi_shell
...
echo "alias kdlds='kubectl delete deployment,service'" | sudo tee -a ~/.$el_shell
