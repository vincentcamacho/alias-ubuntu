...
# Basicos
echo "#ALIAS BASICOS" | sudo tee -a ~/.$el_shell
...
#Sshd
echo "#ALIAS SSHD" | sudo tee -a ~/.$el_shell
...
# Sistema
echo "#ALIAS SISTEMA" | sudo tee -a ~/.$el_shell
...
# Git
echo "#ALIAS GIT" | sudo tee -a ~/.$el_shell
...
# Docker
echo "#ALIAS DOCKER" | sudo tee -a ~/.$el_shell
