...
echo "alias kdp='kubectl delete pod'" | sudo tee -a ~/.$el_shell
echo "alias kdps='kubectl delete pod,service'" | sudo tee -a ~/.$el_shell
echo "alias kdsn='kubectl describe nodes'" | sudo tee -a ~/.$el_shell
echo "alias kdsp='kubectl describe pods'" | sudo tee -a ~/.$el_shell
